...
import { ref } from 'vue';
import { chatRoomList } from '@/static/data/chatData';
...
<template>
  <div class="message-list-container">
    ...
    <div class="message-list">
      <router-link
        :to="'/workspace/chat/' + room.chatroomId"
        class="message-item" v-for="(room) in chatRoomList"
        :key="room.chatroomId">
...
<!--          <span v-if="message.unreadCount" class="unread-count">
