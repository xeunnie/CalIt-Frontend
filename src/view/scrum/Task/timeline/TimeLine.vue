...
<!--        :handles="['ml', 'mr']" :w="width" :h="height" :x="x" :y="y" @resizing="onResize"-->
<!--        @resize-stop="onResizeStop"-->
<!--        @dragging="onDrag" @drag-stop="onDragStop" class="draggable-item">-->
...
(to right, transparent, transparent 99%, #ccc 1%);-->
<!--  background-size: 1fr;-->
<!--}-->
