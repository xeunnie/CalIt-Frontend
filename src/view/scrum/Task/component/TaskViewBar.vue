...
<template>
  <div class="view-toggle-bar">
    <div class="view-toggle-buttons">
      <router-link
          :to="to.startsWith('my') ? `/my/task/${currentView}` : to.startsWith('workspace')
          ? `/workspace/scrum/task/${currentView}` : to"
    ...
    <div v-if="showAvatarGroup" class="avatar-group">
      <img v-for="(avatar, index) in avatars"
           :key="index" :src="avatar.src" :alt="avatar.alt" class="avatar" />
