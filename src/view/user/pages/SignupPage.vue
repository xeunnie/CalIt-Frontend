...
const isEmailEntered = computed(() => email.value.trim() !== '');
const isVerificationCodeEntered = computed(() => verificationCode.value.trim() !== '');
      ...
      <form @submit.prevent="signup">
        ...
        <div v-if="showVerificationCode" class="verify">
          <UserInput
            ...
            input-placeholder="인증 번호를 입력하세요"
            label="인증 번호"
            type="text"
          />
          <button
